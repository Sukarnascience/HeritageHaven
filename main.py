...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        tree = ttk.Treeview(self.viewTabel_km_frame, columns=("SNo.", "Kaval ID", "Kaval Name"))

        # Define column names
        tree.heading("#1", text="SNo.")
        tree.heading("#2", text="Kaval ID")
        tree.heading("#3", text="Kaval Name")
    ...
    def delete_item_from_Kaval_Master(self):
        ...
        print("ID need to Delete is :", dialog.get_input())
